...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        menuTool->addAction(actionCalculateSolutionWattI);
    ...
    void retranslateUi(QMainWindow *MainWindowClass)
    {
        ...
        actionCalculateSolutionWattI->setText(QApplication::translate("MainWindowClass", "Calculate Solutions for Watt I", 0));
